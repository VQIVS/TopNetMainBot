...
product_1 = types.InlineKeyboardButton('1 کاربر |📆 مدت: 30 روز |‌🔵 30 گیگابایت |‌ 79 هزار تومان', callback_data='⭐️ گروه SILVER')
...
product_4 = types.InlineKeyboardButton('3 کاربر |📆 مدت: 30 روز |‌🔵 90 گیگابایت |‌ 159 هزار تومان', callback_data='⭐️ گروه PLATINUM-1')
product_5 = types.InlineKeyboardButton('4 کاربر |📆 مدت: 30 روز |‌🔵 120 گیگابایت |‌ 199 هزار تومان', callback_data='⭐️ گروه PLATINUM-2')
product_6 = types.InlineKeyboardButton('1 کاربر |📆 مدت: 30 روز |‌🔵 حجم نامحدود  |‌ 299 هزار تومان', callback_data='⭐️ گروه DIAMOND')
...
pay_cart = types.InlineKeyboardButton('شماره کارت', callback_data="pay_cart")
