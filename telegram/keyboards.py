...
product_3 = types.InlineKeyboardButton('⚪️ نقره‌ای 1 : یک ماهه 75GB', callback_data='⚪️ نقره‌ای 1 : یک ماهه 75GB')
product_4 = types.InlineKeyboardButton('🟡 طلایی 2 : یک ماهه 100GB', callback_data='🟡 طلایی 2 : یک ماهه 100GB')
